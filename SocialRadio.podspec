Pod::Spec.new do |s|
  ...
  s.license          = { :type => 'MIT', :file => 'builds/SocialRadio/0.19.4/SocialRadio-LICENSE' }
  ...
  s.frameworks = 'Accelerate', 'AudioToolbox', 'Security', 'AVFoundation', 'SafariServices', 'MessageUI', 'CryptoKit', 'UIKit'
  s.vendored_frameworks = "builds/SocialRadio/0.19.4/SocialRadio.xcframework"
  s.platform = :ios
  s.swift_version    = '5.5'
