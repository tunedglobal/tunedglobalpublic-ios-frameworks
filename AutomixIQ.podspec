Pod::Spec.new do |s|
  ...
  s.license          = { :type => 'MIT', :file => 'builds/AutomixIQ/0.18.17/AutomixIQ-LICENSE' }
  ...
  s.frameworks = 'Accelerate', 'AudioToolbox', 'Security', 'AVFoundation', 'Network', 'CoreData', 'CryptoKit'
  s.vendored_frameworks = "builds/AutomixIQ/0.18.17/AutomixIQ.xcframework"
  s.platform = :ios
  s.swift_version    = '5.5'
