Pod::Spec.new do |s|
  ...
  s.license          = { :type => 'MIT', :file => 'builds/AutomixIQ/0.19.0/AutomixIQ-LICENSE' }
  ...
  s.frameworks = 'Accelerate', 'AudioToolbox', 'Security', 'AVFoundation', 'MediaToolbox', 'Network', 'CoreData', 'CryptoKit', 'UIKit'
  s.vendored_frameworks = "builds/AutomixIQ/0.19.0/AutomixIQ.xcframework"
  s.platform = :ios
  s.swift_version    = '5.5'
