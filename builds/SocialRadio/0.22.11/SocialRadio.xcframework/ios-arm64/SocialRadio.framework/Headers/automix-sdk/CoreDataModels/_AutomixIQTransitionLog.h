...
@interface AutomixIQTransitionLogID : NSManagedObjectID {}
@end

@interface _AutomixIQTransitionLog : NSManagedObject
+ (instancetype)insertInManagedObjectContext:(NSManagedObjectContext *)moc_;
+ (NSString*)entityName;
+ (nullable NSEntityDescription*)entityInManagedObjectContext:(NSManagedObjectContext*)moc_;
@property (nonatomic, readonly, strong) AutomixIQTransitionLogID *objectID;
...
@interface _AutomixIQTransitionLog (CoreDataGeneratedPrimitiveAccessors)
...
@interface AutomixIQTransitionLogAttributes: NSObject
+ (NSString *)guid;
