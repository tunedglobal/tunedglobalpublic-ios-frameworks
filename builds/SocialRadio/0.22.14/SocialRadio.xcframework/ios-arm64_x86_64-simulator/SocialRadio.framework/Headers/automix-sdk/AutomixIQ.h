...
extern "C" {
    ...
    int __b_duff_trace_enabled(void);
    int __b_duff_debug_enabled(void);
    int __b_duff_asserts_enabled(void);
...
-(void)addAdsWithMetadata:(nonnull NSArray<TunedAdModel*>*)metadata afterTrackIdentifier:(nullable NSString*)afterTrackIdentifier completion:(nullable CompletionWithError)completion;
-(void)clearAdsWithCompletion:(nullable CompletionWithError)completion;
...
-(void)nextWithBypassSeekTransition:(BOOL)bypassSeekTransition completion:(nullable CompletionWithError)completion;
-(void)previousWithBypassSeekTransition:(BOOL)bypassSeekTransition completion:(nullable CompletionWithError)completion;
-(void)backWithBypassSeekTransition:(BOOL)bypassSeekTransition completion:(nullable CompletionWithError)completion;
...
-(void)seekToSeconds:(float)seconds bypassSeekTransition:(BOOL)bypassSeekTransition completion:(nullable CompletionWithError)completion;
-(void)skipToTrackAtIndex:(int)index bypassSeekTransition:(BOOL)bypassSeekTransition completion:(nullable CompletionWithError)completion;
