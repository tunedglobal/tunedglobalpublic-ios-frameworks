...
-(void)addAdsWithIdentifiers:(nonnull NSArray<NSString*>*)identifiers metadata:(nonnull NSArray<TunedAdModel*>*)metadata completion:(nullable CompletionWithError)completion;
