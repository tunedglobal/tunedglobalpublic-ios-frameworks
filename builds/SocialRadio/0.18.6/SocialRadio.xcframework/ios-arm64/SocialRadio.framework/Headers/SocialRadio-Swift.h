...
/// \param identifiers The list of identifiers of the ads.
///
...
///
///
- (void)addAdsWithIdentifiers:(NSArray<NSString *> * _Nonnull)identifiers metadata:(NSArray<TunedAdModel *> * _Nonnull)metadata completion:(void (^ _Nullable)(NSError * _Nullable))completion;
...
///
///
- (void)canPlayAdsWithIdentifiers:(NSArray<NSString *> * _Nonnull)identifiers metadata:(NSArray<TunedAdModel *> * _Nonnull)metadata completion:(void (^ _Nonnull)(NSError * _Nullable, BOOL))completion;
@end
...
/// Objective-C accessible member for the adId
@property (nonatomic, readonly) NSInteger adIdentifier;
...
///
- (nonnull instancetype)initWithAdId:(NSInteger)adId url:(NSString * _Nonnull)url duration:(NSInteger)duration name:(NSString * _Nullable)name artists:(NSArray<TunedArtistModel *> * _Nullable)artists image:(NSString * _Nullable)image OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
