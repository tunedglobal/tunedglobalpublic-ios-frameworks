...
+(BOOL)isManagingNowPlayingDictionary;
...
-(void)userProfileChangedWithIdentifier:(nonnull NSString*)identifier
                                  alias:(nullable NSString*)alias
                          userThumbnail:(nullable NSString*)userThumbnail;
-(void)userProfileChangedWithIdentifier:(nonnull NSString*)identifier;
...
-(void)joinLiveUserWithIdentifier:(nonnull NSString*)identifier
                       completion:(void (^_Nullable)(NSError* _Nullable error, UIViewController* _Nullable viewController))completion;
