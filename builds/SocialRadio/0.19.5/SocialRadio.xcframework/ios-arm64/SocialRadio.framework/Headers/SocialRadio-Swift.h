...
///
///
- (void)refreshCredentialsWithOldAccessToken:(NSString * _Nullable)oldAccessToken refreshToken:(NSString * _Nullable)refreshToken tokenType:(NSString * _Nullable)tokenType completion:(void (^ _Nonnull)(NSError * _Nullable, SocialRadioCredentials * _Nullable, NSString * _Nullable))completion;
@end
