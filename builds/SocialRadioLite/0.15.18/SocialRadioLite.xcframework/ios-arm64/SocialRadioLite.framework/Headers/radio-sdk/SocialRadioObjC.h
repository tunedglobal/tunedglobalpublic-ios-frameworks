...
socialRadioTunedRestDelegate:(nonnull id<SocialRadioTunedRestDelegate>)socialRadioTunedRestDelegate
...
-(void)startRadioSessionWithIdentifiers:(nonnull NSArray<NSString*>*)identifiers
                               metadata:(nullable NSArray<SocialRadioTrackModel*>*)trackMetadataArray
